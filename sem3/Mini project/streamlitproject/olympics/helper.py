...
def AthletePred(df, age, sex, height, weight, region, city, sport):
    """
    ...
    - Height: Float representing the athlete's height in centimeters
    - Weight: Float representing the athlete's weight in pounds
    ...
    data = pd.DataFrame([age, sex, height, weight, region, city, sport], index=['Age', 'Sex', 'Height', 'Weight', 'region', 'City', 'Sport'])
    data = data.T
